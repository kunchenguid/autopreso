...
test("whiteboard prompt tells the agent to avoid text and label overlap", () => {
  ...
  assert.match(prompt, /Standalone text is only for titles, section headers, captions, legends, and axis labels/);
  ...
  assert.match(prompt, /Leave at least 32 px of empty space/);
